...
// 	}
	...
	var frm = document.readForm;
	frm.action = "/web_portfolio/goProfileUpdate.do";
	frm.method = "post";
	frm.submit();
	}
</script>
						...
						<fieldset>
							...
							<table summary="회원 정보 입니다." class="table table-hover">
								...
								<tbody>
									<tr>
										...
										<td class="tleft" colspan="3">&nbsp&nbsp${user.userId}</td>
									</tr>
									<tr>
										<th class="tright">성명</th>
										<td class="tleft" colspan="3">&nbsp&nbsp${user.userName}</td>
									</tr>
									<tr>
										<th class="tright">별명</th>
										<td class="tleft" colspan="3">&nbsp&nbsp${user.nickname}</td>
									</tr>
									<tr>
										<th class="tright">이메일</th>
										<td class="tleft" colspan="3">&nbsp&nbsp${user.email}</td>
									</tr>
									...
									<tr>
										...
										<td colspan="3" class="tleft">
											<div class="col-xs-3"><input class="form-control" type="password" id="userPw" name="password" title="비밀번호 입력박스" class="input_100" />
							...
							<div class="btn_bottom">
								<div class="btn_bottom_left">
									...
									<input type="button" class="btn btn-primary" onclick="doDelete()" value="탈퇴하기" title="탈퇴하기" />
									
								</div>
								<div class="btn_bottom_right">
									<input type="button" class="btn btn-primary" onclick="goProUpdate()" value="수정" title="수정" /> 
								</div>
							</div>
							<!-- //bottom button -->
