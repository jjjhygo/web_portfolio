...
public String toString() {
	return "Attachment [attachSeq=" + attachSeq + ", attachDocType=" + attachDocType + ", attachDocSeq=" + attachDocSeq
			+ ", filename=" + filename + ", fakeName=" + fakeName + ", fileSize=" + fileSize + ", contentType="
